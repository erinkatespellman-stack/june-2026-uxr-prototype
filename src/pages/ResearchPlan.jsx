    ...
    <Shell breadcrumbs={['Research', 'Research Plan']}>
      <main style={{ flex: 1, overflowY: 'auto', background: '#FAFAFA', color: theme.color.text, padding: '48px 56px 80px' }}>
        ...
        <div style={{ background: '#F3EFFC', border: '1px solid #E2D5F6', borderRadius: theme.radius.lg, padding: '18px 20px', marginBottom: 30 }}>
          <div style={{ fontSize: 11, fontWeight: 700, color: '#7A4DD0', letterSpacing: 0.4, textTransform: 'uppercase', marginBottom: 6 }}>In plain terms</div>
          <div style={{ fontSize: 14.5, color: theme.color.text, lineHeight: 1.6 }}>
        ...
        <Card title="2 · What we want to learn">
          <ol style={{ margin: 0, paddingLeft: 20, fontSize: 13.5, color: theme.color.text, lineHeight: 1.7 }}>
            <li>For amenities and for email versions <em>(we ask about each on its own — people often feel differently)</em>: do they want AI to do <strong>less, more, or about the same?</strong></li>
        ...
        >
          <table style={{ width: '100%', borderCollapse: 'collapse' }}>
            ...
            <tbody>
              <tr>
                <td style={td}>Marketers who build these emails today<br /><span style={{ color: theme.color.textMuted, fontSize: 12 }}>property &amp; area marketing managers</span></td>
              ...
              <tr>
                <td style={td}>People who approve guest emails<br /><span style={{ color: theme.color.textMuted, fontSize: 12 }}>brand reviewers / sign-off</span></td>
                <td style={td}>They care most about protecting the brand — that shapes what needs a sign-off step</td>
        ...
        >
          <div style={{ background: '#F3EFFC', border: '1px solid #E2D5F6', borderRadius: theme.radius.md, padding: '16px 18px', marginBottom: 16 }}>
            <div style={{ fontSize: 11, fontWeight: 700, color: '#7A4DD0', letterSpacing: 0.4, textTransform: 'uppercase', marginBottom: 6 }}>What we ask, word for word</div>
          ...
          <div style={{ fontSize: 13, color: theme.color.text, fontWeight: 600, marginBottom: 8 }}>We write down three things each time</div>
          ...
          <div style={{ fontSize: 13, color: theme.color.text, fontWeight: 600, marginBottom: 8 }}>Good follow-up questions</div>
        ...
        <Card title="6 · How we'll keep the findings honest" caption="A few habits that stop us from fooling ourselves.">
          <ul style={{ margin: 0, paddingLeft: 20, fontSize: 13, color: theme.color.text, lineHeight: 1.75 }}>
            ...
            <li><strong>Keep amenities and email versions separate</strong> — don't let the two blur together.</li>
          </ul>
        </Card>
        ...
        <Card title="7 · What you'll get at the end">
          <ul style={{ margin: 0, paddingLeft: 20, fontSize: 13, color: theme.color.text, lineHeight: 1.75 }}>
            <li>A simple picture of where each person landed — <strong>less / just right / more</strong> — for amenities and for versions.</li>
        ...
        <Card title="8 · The practical bits">
          <div style={{ fontSize: 13, color: theme.color.text, lineHeight: 1.7 }}>
            ...
            <button onClick={() => navigate('/report')} style={{ background: 'none', border: 'none', padding: 0, color: theme.color.link, fontWeight: 600, cursor: 'pointer', fontSize: 13, fontFamily: 'inherit' }}>live results report</button>{' '}
